...
export default function PaginaInicial() {
  //const username = 'ronara';
  const [username, setUsername] = React.useState('ronara');
    ...
    <>
     <Box
        styleSheet={{
          ...
          backgroundColor: appConfig.theme.colors.primary[250],
          ...
          >
            ...
            <Button
              ...
              buttonColors={{
                ...
                mainColor: appConfig.theme.colors.primary[750],
          ...
          >
            ...
            <Text
              ...
              styleSheet={{
                ...
                backgroundColor: appConfig.theme.colors.neutrals[400], //900
                padding: '3px 10px',
                borderRadius: '1000px'
              }}
            >
